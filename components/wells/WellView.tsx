...
const styles = {
  ...
  tabBtn: (active: boolean) => ({
    padding: "12px 22px",
    borderRadius: 999,
    border: `2px solid ${active ? "var(--color-brand-mid)" : "var(--color-border-medium)"}`,
  ...
  modeBtn: (active: boolean) => ({
    padding: "10px 18px",
    borderRadius: 999,
    border: `2px solid ${active ? "var(--color-brand-primary)" : "var(--color-border-medium)"}`,
...
export function WellIcon({width = 18, height = 18}: {width?: number; height?: number}) {
  return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M18 5.5v13a2 2 0 01-2 2H8a2 2 0 01-2-2v-13" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
